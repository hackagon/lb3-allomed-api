...
const enterprisesTable = require('../../common/data/tables/get.enterprises.table.json');
...
module.exports = (server) => {
  ...
  router.get(`${restApiRoot}/tables/enterprises`, (req, res) => res.json(enterprisesTable))
